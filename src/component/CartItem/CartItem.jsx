        ...
        <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
          ...
          <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
            <div className="flex items-center border-gray-100">
              ...
              <input className="h-8 w-28 border bg-white text-center text-xs outline-none" 
              type="number" 
              onChange={(e) => {
              ...
              <button className="disabled:cursor-not-allowed cursor-pointer rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50" 
              disabled={disableBtn}
              type="button"
            ...
            <div className="flex items-center space-x-4">
              ...
              className='btn bg-red-200 hover:bg-red-400 rounded-xl p-4 flex items-center gap-2'>
